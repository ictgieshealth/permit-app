...
export default function CreateMenuPage() {
  ...
  const loadRoles = async () => {
    try {
      const response = await roleService.getAll({ limit: 100, is_active: true });
  ...
  const loadParentMenus = async () => {
    try {
      const response = await menuService.getAll({ limit: 100, is_active: true });
  ...
  return (
    <div className="max-w-2xl p-6 mx-auto">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Create New Menu</h1>
